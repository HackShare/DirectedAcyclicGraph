...
public class TopologicalSorting {
	...
	{
		TopologicalSorting topologicalSort=new TopologicalSorting();
		topologicalSort.constructGraph();
		topologicalSort.doTopologicalSorting(graph);
	 ...
	 * 
	 */
	public void doTopologicalSorting(Graph G)
	{
		graph=G; //This will be useful if we call  this function from other classes
